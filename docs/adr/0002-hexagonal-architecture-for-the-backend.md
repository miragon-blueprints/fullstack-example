...
The scaffolding skills ([`create-rest-controller`](../../.claude/skills/create-rest-controller/SKILL.md),
[`create-delegate`](../../.claude/skills/create-delegate/SKILL.md),
[`create-persistence-adapter`](../../.claude/skills/create-persistence-adapter/SKILL.md),
[`automate-process`](../../.claude/skills/automate-process/SKILL.md)) generate code that already obeys
these rules.
...
- **Neutral:** the generated-code seam (`adapter/process`) is a permanent, documented exception; see
  [ADR-0004](0004-openapi-as-the-checked-in-contract.md) for the analogous frontend generated seam.
